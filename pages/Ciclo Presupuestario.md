	...
	- Son 6,  en el orden:
		...
		- 6. Clausura y Liquidación
			...
			- ¿Qué es la Liquidación Presupuestaria?
				...
				- Si no gasto el presupuesto establecido, este sobrante regresa a las arcas fiscales, no se acumula , incluso se te puede dar un valor menor por no haber ejecutado el presupuesto,
- 1. Planes y metas
