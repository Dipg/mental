...
- Diseño de Estructura de Incentivos  {{renderer :wordcount_masmdewch}}   ==Maximo de Palabras 3.500 – 4.000==
	...
	- Cuando  no  se  puede  utilizar  efectivo  en  absoluto,  puede  ser  útil  una  combinación de lotería y tarjetas regalo. Por ejemplo, ganar 23$ en este caso  podría  pagarse  con  una  tarjeta  regalo  de  20$  y  una  lotería  con  probabilidad de 0,3 para ganar otra tarjeta regalo de 10$.
		- Así mismo dentro de los incentivos no económicos encontramos un  que un incentivo para participar en un experimento puede ser la obtención de créditos para cumplir con  un  requisito de titulación par a estudiantes universitarios. Esto se puede llevar acabo con otro tipo de crédito académico el cual consiste en que los estudiantes obtengan unos puntos extra en la nota del curso  si participan en un experimento al igual que en el caso anteriror
	-
	-
	-
	-
