...
- Diseño de Estructura de Incentivos
	...
	- Hay  varios  argumentos  a  favor  de  aceptar  también  los  experimentos que carecen de incentivos basados en el rendimiento. Contextos  que  implican  un  horizonte  temporal  muy  largo  o  grandes cantidades de dinero son difíciles de estudiar con experimentos con  incentivos  reales por ejemplo decisiones d ahorro de jubilación. A mas de esto realizar un experimento sin incentivos puede tener algunas ventajas, con el echo de que la ciencia avance si la idea de un experimento que no se puedo llevar a cabo por falta de incentivos se llevara acabo sin estos, preferiblemente a no realizar ninguntipo de estudio. Otro beneficio de los experimeitnos sin incentivos es que no generan una respuesta artifical  por lo que no perjudica de gran manera a la validexz  externa.
