...
- Diseño centrado en Incentivos
	...
	- Marco General
		...
		- Que se lee como: Un elemento dominante del conjunto $E$ es igual a $x$ dado que $x$ `pertenence al conjunto $E$ tal que para todo $y$ que pertenence a $E$  $x$ es mayor o igual a $y$
