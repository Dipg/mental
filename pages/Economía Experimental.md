...
- Diseño de Estructura de Incentivos  {{renderer :wordcount_masmdewch}}   ==Maximo de Palabras 3.500 – 4.000==
	...
	- Así mismo dentro de los incentivos no económicos encontramos un  que un incentivo para participar en un experimento puede ser la obtención de créditos para cumplir con este requisito de titulación.
