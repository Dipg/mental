...
- # [](#7.)  [[Tarifa en Bloque Creciente]]
	- ¿Cuáles son los pasos para la creación de una tarifa en bloques creciente?
		...
		- SI el ingreso calculado no es igual al ingreso requerido, repita desde el paso 1 (para cambiar el número de bloques), o el paso 2 (para cambiar el número de bloques), o el paso 2(para cambar los limites de consumo) o el paso 3 (para )
-
-
-
-
