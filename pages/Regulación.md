	...
	- Ejercicios
	  collapsed:: true
		...
		- collapsed:: true
		  ...
		  \begin{aligned}
		  &P=C_{\text {me }} \\
		  &121,43=\frac{Q}{210}=\frac{F}{Q}+50 \\
		  &71,4Q-\frac{Q ^{ 2}}{210}-F=0 \\
		  &Q^{2}-15000 Q-210 F=0 \\
		  &Q=\frac{15000 \pm \sqrt{(15000)^{2}-4(1)(210 F)}}{2} \\
		  &Q*=\frac{15000 + \sqrt{(15000)^{2}-4(1)(210 F)}}{2} \\
		  &75002>=210F
		  \end{aligned}
		  $$
		- collapsed:: true
		...
		- collapsed:: true
		  ...
		  &\pi=350 Q_{1}-0,1 Q_{1}^{2}+440 Q_{1}-0,08 Q_{1}^{2}-F-250 Q_{1}=0 \\
		...
		- collapsed:: true
		  $$
		  \begin{aligned}
		  &Excce1=(350-200+0,56 ( \sqrt{270^{2}-0,18 F})(1500+5,56  \sqrt{270^{2}-0,18 F}) / 2 \\
		...
		-
		  ...
		  \end{aligned}
		  $$
		- El precio Ramsey nos permite obtener un optimo para mejorar el bienestar social y que el productor obtenga beneficio cero
		-
		-
...
- Viideos
	...
	- Precios Libres de subsidios
		- [:video {:controls true :src "G:/Otros ordenadores/Mi OrdenadorHabilidades\Universidad\Regulación\Video Clases\precios_libre_subsi.mp4"}]
	- Tarifas no lineales
	  collapsed:: true
