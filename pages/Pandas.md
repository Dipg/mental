...
- Convertir en flotante
	- La evidencia proporcionada en la Figura 6 sugiere que no. Esto agrupa a los países midiendo su desempeño en términos de crecimiento económico contra sus patrones de distribución del ingreso, como lo indica el coeficiente de Gini, una medida de cómo la distribución del ingreso se desvía de una situación hipotética en la que todos tienen exactamente el mismo ingreso. Las desviaciones de 0 (igualdad perfecta) a 1 (desigualdad total) indican el grado de desigualdad. Es cierto que la metodología proporciona, en el mejor de los casos, un indicador limitado de las relaciones causales en juego. El coeficiente de Gini proporciona solo una instantánea estática basada en cifras promedio, lo que oscurece la interacción dinámica entre la distribución y los patrones de crecimiento. Además, los factores de distribución son solo uno entre varios factores, y sus efectos no se aíslan en esta instantánea. Con estas consideraciones en mente, ¿qué nos dice el ejercicio? A un nivel, no mucho. La imagen que surge no es concluyente. Países como Botswana y Chile ilustran que es perfectamente posible combinar un alto crecimiento con altos niveles de desigualdad, con costos obvios para la reducción de la pobreza. Dos países de Asia oriental, Malasia y Tailandia, se inclinan hacia este grupo. Otros, como India, demuestran que es igualmente posible combinar niveles relativamente altos de igualdad con un crecimiento bajo. La mayoría, sin embargo, logran el peor de los mundos posibles: a saber, una gran desigualdad junto con un bajo crecimiento. Gran parte de África y América Latina encaja en esta categoría, aunque el este de Asia también está representado por Filipinas. Con su estructura de propiedad de la tierra y distribución de ingresos al estilo latinoamericano, este país es un ejemplo del peor de los casos. En el otro extremo del espectro, en el noroeste