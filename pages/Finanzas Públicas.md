	...
	- Finanzas Públicas #red
	  collapsed:: true
		...
		- ¿ Cuales son las funciones de las finanzas Públicas? #red
		  collapsed:: true
			- [](#1.)  Evaluar la ejecución del {{cloze presupuesto general del estado}} de ingresos y egresos del Estado y proponer al Ejecutivo medidas correctivas de su competencia.
