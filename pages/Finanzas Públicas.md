	  ...
	  :END:
		...
		- # Presupuesto General [[PGE]]
			- ¿ Que es el [[PGE]] ?
				...
				- El PGE también incluye el [[Gasto Público]], el gasto que el estado realiza para el funcionamiento de sus instituciones y la dotación de servicios y el finacimeinto
				-
		-
	- # Curva de Lafer
