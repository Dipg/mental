	...
	- Política Fiscal Contractiva #red
	  collapsed:: true
		- ¿ Que es una política fiscal Contractiva?
			- Es aquella que se da en situaciones inflacionistas🧐 ![image.png](../assets/image_1644629320122_0.png){:height 47, :width 69} *Si se tienen una alta inflación esto quiere decir que según la [[Curva de Philips]]  el Empleo seera meor, por lo que la politica contractiva se aplica cuando existe poco desempleo*🧐, provocada esta por un exceso de [[Demanda Agregada]] , reduciendo así el gasto agregado.
			- Acciones:
			  collapsed:: true
