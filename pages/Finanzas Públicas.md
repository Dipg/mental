			  ...
			  collapsed:: true
				...
				- Bien público Puro
				  collapsed:: true
					...
					- Así pues, Ante un Menor costo Marginal de Uso en combinación con Una menor Facilidad de Exclusión → Se obtiene Un Bién Publico Puro (Ejemplo : Defensa Nacional)
