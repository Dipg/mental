	...
	- Finanzas Públicas #red
	  collapsed:: true
		...
		- ¿Qué es el [[Gasto Público]] ? #red
		  collapsed:: true
			- Es al [[Inversión]] que realiza el [[Estado]] en {{cloze distintos proyectos de interés Social}}, para poder concretar las inversiones, es decir mantener el   se {{cloze debe asegurar el recaudo}} de [[Impuestos]]
