		...
		- Estimación de la Frontera de costos para el sector manufacturero de Ecuador
		  collapsed:: true
			- # 1. Datos
				...
				- La base de datos contaba inicialmente con un tota de 49829 empresas, misma de la cual se eliminaron aquellas empresas que no contaran con registro de las variables utilizadas para la estimación, quedando así un total de 1202 observaciones,  de las cuales se filtro el sector manufacturero. Dentro de este sector se busco aquellas empresas que cuenten con un capital fijo similar, por lo cual se generaron 4 bloques de empresas según su valor de capital fijo, esto ya que en la industria manufacturera uno de los principales aspectos es su alta inversión en capital fijo necesaria para la generación de productos. Al realizar la división menciona encontramos  pasamos de un gran numero de empresas no homogeneas como en la ilustración 1
