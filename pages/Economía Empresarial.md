		...
		- Estimación de la Frontera de costos para el sector manufacturero de Ecuador
		  collapsed:: true
			- # 1. Datos
				...
				- Por el lado de la varíale trabajo, se eligió como proxy los costos de sueldos y salarios, mismo que se establecen con intern directa o indirecta en la producción
