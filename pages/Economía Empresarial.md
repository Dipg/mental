		...
		- Estimación de la Frontera de costos para el sector manufacturero de Ecuador
		  collapsed:: true
			...
			- # 3. Estimación de Frontera de Costos
				...
				- En primer momento podemos decir que se rechaza la hipótesis nula que valora la  ineficiencia interna, esto es existe una ineficiencia interna mayor que la ineficiencia e
-