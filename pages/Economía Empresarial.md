	...
	- Estimación
		- Estimación de la Frontera de costos para el sector manufacturero de Ecuador
			...
			- 1. Obtención de Datos
				- Los datos se obtuvieron de superintendencia de compañías para el año 2017, las cuentas que se seleccionaron con sus respectivos códigos fueron ; Costos con el codigo 7991;
-
-