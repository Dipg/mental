		...
		- Estimación de la Frontera de costos para el sector manufacturero de Ecuador
		  collapsed:: true
			- # 1. Datos
				...
				- La relación muestra un comportamiento casi lineal, por lo cual con las empresas seleccionadas se podría mencionar que un nivel de activos fijos genera genera un incremento de ventas casi constante
