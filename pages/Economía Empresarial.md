		...
		- Estimación de la Frontera de costos para el sector manufacturero de Ecuador
		  collapsed:: true
			- # 1. Datos
				...
				- Se puede observar en la grafica anterior, que existe en general una relación directa entre el capital y las ventas, echo que se esperaba, sin embargo  como se puede observar en el grafico,  el valor de netas no simpre incrementa con mayores
