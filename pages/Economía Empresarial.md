		...
		- Estimación de la Frontera de costos para el sector manufacturero de Ecuador
		  collapsed:: true
			- # 1. Datos
				...
				- Como se observa en la tabla anterior, los costos pueden llegar a ser extremadamente altos  de hasta 12 millones de dólares. Sin embargo a diferencia de los Activos fijos, el costo total
