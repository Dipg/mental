  ...
  :END:
	...
	- # Normalización de bases de datos
		...
		- ## Segunda Forma Normal (2FN)
			- Se da cuando si esta esta en 1FN  y todos los atributos que no son clave principal deben depender únicamente de la clave principal, es decir existe un dee
